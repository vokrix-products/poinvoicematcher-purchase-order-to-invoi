...
export const statuses: {
  ...
  { label: 'Needs Review', value: 'Needs Review:warning', icon: Clock, severity: 'warning' as Severity },
  { label: 'On Hold', value: 'On Hold:warning', icon: Clock, severity: 'warning' as Severity },
